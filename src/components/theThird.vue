        ...
        <div class=" bg-white ">
            <div class=" w-5/6 lg:w-4/6   flex mx-auto py-3">
                <div class="  w-2/6 lg:w-2/6 flex justify-center items-center ">
                    <h1 class="text-4xl lg:text-6xl font-oswald font-bold text-footerbluebg opacity-60   ">02 <span>.</span></h1>
                    <p class="lg:text-2xl font-oswald font-bold  -ml-2 lg:-ml-4 text-darkbluebg">CLIMB</p>
                </div>
          
                <div class="w-4/6  flex justify-start items-center">
                    <p class="  font-smallertext text-xs  lg:text-base leading-tight ">Cray scelerisque id quam sed Pellentesque urna nunc gravida quis hendrerit ac,<span class="hidden lg:inline" >tistesque ut quam. Vivamuus suscript disnissim totor nec congue.</span> </p>
                </div>
